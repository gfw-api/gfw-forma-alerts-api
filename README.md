...
The GFW Forma Alerts microservice is built using [Node.js](https://nodejs.org/en/), and can be executed either natively or using Docker, each of which has its own set of requirements.
...
```
git clone https://github.com/gfw-api/gfw-forma-alerts-api.git && cd gfw-forma-alerts-api
```
